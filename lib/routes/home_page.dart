import 'package:basic_app/components/error_view.dart';
      ...
      body: ListView(
            ...
            children: <Widget>[
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          ...
                          Padding(
                            ...
                            Text('Usuario Destacado : Rodrigo Carvajal'
                                '\nt'
                                '\nr'
                                '\nwewe'
                              ,
              ...
              IconButton(
                ...
                iconSize: 58.0,
                onPressed: () {
                  GoRoute(context).to(AlbumScreen(),routeEffect: RouteEffect.CupertinoDefault);
                  //GoRoute(context).toNamed(RoutesConfig.album_screen,routeEffect: RouteEffect.Fade);
                },
              ),
